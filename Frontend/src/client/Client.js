...
export default function Client() {
  ...
  async function submitClient() {
    ...
    if (formState['name'].length < 4)
      ...
      errorMsg.innerHTML = "Por favor, adicione um número de contato do cliente!"  
        ...
        <div className="container-client-form gray mt-1">
          <div className="form-set-container">
            ...
            <div className="one-form-input">
              ...
              <input className="input-default" type="text" id="city" placeholder="Cidade" defaultValue="Aracaju" 
                onChange={(event) => changeForm(event.target)}
              />
            </div>
            ...
            <div className="one-form-input">
              ...
              <input className="input-default" type="text" id="state" placeholder="Estado" defaultValue="SE"
                onChange={(event) => changeForm(event.target)}
              />
            </div>
          </div>
